  ...
  <div class="w3-card-4 w3-margin w3-white">
    ...
    <div class="w3-container">
     ...
     <div class="w3-col m8 s12">
          <p><button class="w3-button w3-padding-large w3-white w3-border"><b><a href = "insert_faculty_v2.html">Add Faculty »</a></b></button></p>
        </div>
    </div>
  </div>
  <hr>
...
<li>For glimpse of various research activities at IIT Patna,the Research Brochure for IIT Patna may be viewed.</p></ul>
      <div class="w3-row">
        <div class="w3-col m8 s12">
          <p><button class="w3-button w3-padding-large w3-white w3-border"><b><a href = "insert_project_v2.html">Insert new Project »</a></b></button></p>
        </div>
        <div class="w3-col m8 s12">
          <p><button class="w3-button w3-padding-large w3-white w3-border"><b><a href = "insert_publication.html">Insert new Publication »</a></b></button></p>
        </div>
